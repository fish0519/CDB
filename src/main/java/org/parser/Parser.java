...
public class Parser
{
  ...
  private static final String[] yytname_init()
  {
    return new String[]
    {
  "\"end of file\"", "error", "\"invalid token\"", "NL", "NUM", "'-'",
  "'+'", "'*'", "'/'", "NEG", "'^'", "'('", "')'", "$accept", "input",
  "line", "exp", null
    };
  }
  ...
  public interface Lexer {
    ...
    /** Token NL, to be returned by the scanner.  */
    static final int NL = 258;
  ...
  if (yyn == 5)
    /* "Parser.y":36  */
        ...
        result.append(" = " + ((Float)(yystack.valueAt (1))));
    };
  break;
  ...
  if (yyn == 7)
    /* "Parser.y":43  */
                          { yyval = ((Float)(yystack.valueAt (2))) + ((Float)(yystack.valueAt (0))); };
  break;
  ...
  if (yyn == 12)
    /* "Parser.y":48  */
                    { yyval = Math.pow(((Float)(yystack.valueAt (2))),((Float)(yystack.valueAt (0)))); };
  break;
...
/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
  ...
  private static final byte[] yypact_init()
  {
    return new byte[]
    {
      -9,    12,    -9,    -9,    -9,     9,     9,    -9,    19,    -8,
      25,    -9,     9,     9,     9,     9,     9,    -9,    -4,    -4,
      -8,    -8,    -8
    };
  }
...
/* YYDEFACT[STATE-NUM] -- Default reduction number in state STATE-NUM.
  ...
  private static final byte[] yydefact_init()
  {
    return new byte[]
    {
       2,     0,     1,     4,     6,     0,     0,     3,     0,    11,
       0,     5,     0,     0,     0,     0,     0,    13,     8,     7,
       9,    10,    12
    };
  }
...
/* YYTABLE[YYPACT[STATE-NUM]] -- What to do in state STATE-NUM.  If
  ...
  private static final byte[] yytable_init()
  {
    return new byte[]
    {
       9,    10,    16,    14,    15,     0,    16,    18,    19,    20,
      21,    22,     2,     4,     5,     3,     4,     5,     0,     0,
       6,     0,    11,     6,    12,    13,    14,    15,     0,    16,
...
private static final byte[] yycheck_ = yycheck_init();
  private static final byte[] yycheck_init()
  {
    return new byte[]
    {
       5,     6,    10,     7,     8,    -1,    10,    12,    13,    14,
      15,    16,     0,     4,     5,     3,     4,     5,    -1,    -1,
      11,    -1,     3,    11,     5,     6,     7,     8,    -1,    10,
       5,     6,     7,     8,    -1,    10,    -1,    12
    };
  }
